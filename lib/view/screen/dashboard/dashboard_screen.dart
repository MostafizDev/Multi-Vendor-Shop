    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: FancyBottomNavBar(
          barBackgroundColor: ColorResources.getPrimary(context),
          circleColor: ColorResources.WHITE,
          activeIconColor: ColorResources.COLOR_SECONDARY,
          inactiveIconColor: ColorResources.COLOR_SECONDARY,
          textColor: ColorResources.COLOR_SECONDARY,
          key: _bottomNavKey,
